...
public:
	...
	void execute(std::string code) {
		...
		else if (code == "SUM_C=1") {
			SUM(A, B, 1);
		}
		else if (code == "SUM_C=0") {
			SUM(A, B, 0);
		}
		else if (code == "SUB_C=1") {
			SUB(A, B, 1);
		}
		else if (code == "SUB_C=0") {
			SUB(A, B, 0);
		}
		else if (code == "MUL_C=1") {
			MUL(A, B, 1);
		}
		else if (code == "MUL_C=0") {
			MUL(A, B, 0);
		}
		else if (code == "DIV_C=1") {
			DIV(A, B, 1);
		}
		else if (code == "DIV_C=0") {
			DIV(A, B, 0);
		}
