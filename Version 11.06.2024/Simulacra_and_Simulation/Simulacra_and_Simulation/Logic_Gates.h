...
public:
	...
	bool* MultiPlexer (bool s1[8], bool s2[8], bool s3[8], bool s4[8], bool sel1, bool sel2)
	{
		if (and_gate(sel1, sel2)){return s1;}
		else if (sel1 == true && sel2 == false){return s2;}
		else if (sel1 == false && sel2 == true){return s3;}
		else{return s4;}
	}
