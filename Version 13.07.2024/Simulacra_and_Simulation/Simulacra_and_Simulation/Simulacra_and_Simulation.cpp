...
int main()
{
	...
	cout << "\n  APPLE I or ][ style but its have differents the APPLE, still have a two programming language. Binary & Executive";
	cout << "\n  Starting date : 16.06.2024    Version : 1.0.2.16  /  13.07.2024\n  Do you want a new version ? let me check it -->  https://github.com/917Cebrail/8-Bit-CPU-Simulation";
